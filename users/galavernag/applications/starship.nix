...

{
  programs.starship = {
    ...
    settings = {
      ...
      # Formatação principal (usando '' para strings multilinha no Nix)
      format = ''
      ...
      battery = {
        ...
        # [[battery.display]] converte para uma lista de objetos
        display = [
          {
            threshold = 20;
      ...
      git_status = {
        ...
        # Note o uso de \${count} para escapar a variável dentro da string Nix
